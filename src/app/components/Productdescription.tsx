...
const Productdescription = () => {
  return (
    <div className="sm:w-[1440px] w-[414px] flex flex-col items-center justify-center gap-[17px] ">
    <div id="top" className="sm:w-[1440px] w-[414px] h-[91px] flex items-centersm:p-0 px-[21px] py-[9.5]  justify-center ">
        <div id="nav" className="w-[1051px] flex items-center justify-center">
    ...
    <div id=" main div" className="sm:w-[1440px]  flex justify-center">
        <div id="container" className=" pt-6 pb-12">
            <div id="row" className="sm:w-[1056px] flex sm:flex-row flex-col gap-[30px]">
                <div className="bg-[url('/unsplash.png')] sm:w-[316px] sm:h-[372px] rounded-[5px] mr-4 mb-[21px] flex justify-between  w-[321px] h-[271px] bg-cover sm:bg-center bg-left-bottom px-10 pt-[119px] sm:pt-[260px]"></div>
