...
import hero from "../assets/hero-cover-3.png"
import herosml from "../assets/hero-cover-3sml.png"


const Universe = () => {
  return (
    <div className="sm:w-[1440px] sm:h-[682px] w-[414px] pt-[120px] sm:pt-0 px-[9.83px] sm:px-0 ">
        <div id="row" className=" flex gap-[30px] sm:pl-[132px] items-center sm:flex-row flex-col">
            <Image src={hero} alt="" className="sm:block hidden"/>
            <div id="text content" className=" flex flex-col gap-[30px] sm:pr-[198px]">
                <h5 className="font-montserrat font-bold text-[16px] leading-[24px] tracking-[0.1px] text-[#BDBDBD] sm:mx-0 mx-[136.17px]">SUMMER 2020</h5>
